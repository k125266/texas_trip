...
const dayData = {
    ...
    4: {
        activities: [
            ...
            { time: '19:00', title: '<img src="basketball-icon.png" alt="Basketball" class="basketball-icon"> NBA 賽事', desc: '<strong>Dallas Mavericks vs OKC Thunder</strong><br>📍 American Airlines Center(車程 10 分鐘)<br>💡 建議 17:30-18:00 先到附近用簡餐', price: '門票 $120 ≈ NTD 3,840<br>停車 $25-40 ≈ NTD 800-1,280', isNBA: true }
        ],
        budget: 'NTD 5,200'
    },
    5: {
